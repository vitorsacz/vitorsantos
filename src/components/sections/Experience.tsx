...
export const Experience = () => {
  ...
  return (
    <Section id="experience" className="border-t border-[#222]">
      <Reveal>
      ...
      <div className="space-y-0">
        {items.map((exp: any, idx: number) => (
          <div key={idx} className="border-b border-[#222]">
            <Reveal>
              <div className="grid md:grid-cols-12 gap-12 py-16 items-start">
                <div className="md:col-span-4">
                  <div className="sticky top-24">
                    ...
                    <p className="text-[#666] font-mono text-[10px] uppercase tracking-[0.2em]">{exp.role}</p>
                  </div>
                </div>
                
                <div className="md:col-span-8 md:border-l md:border-[#222] md:pl-12 pb-8">
                  <p className="text-2xl text-[#BBB] leading-relaxed mb-12 font-serif italic pr-12">
                    {exp.description}
                  </p>
                  <div className="grid sm:grid-cols-1 gap-8">
                    {exp.highlights.map((highlight: string, hIdx: number) => (
                      <div key={hIdx} className="flex gap-6 items-start group">
                        ...
                        <p className="text-[13px] text-[#888] leading-relaxed font-mono uppercase tracking-tight">{highlight}</p>
                      </div>
                    ))}
                  </div>
                </div>
