  ...
  return (
    <Section className="min-h-[90vh] flex items-center relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-end w-full">
        <div className="md:col-span-9">
          ...
          <Reveal delay={0.2}>
            <div className="flex gap-8 items-start">
              ...
              <p className="text-xl md:text-2xl font-light text-[#BBB] leading-relaxed italic pr-12 font-serif max-w-2xl">
                {t('hero.description')}
              </p>
            </div>
          </Reveal>
        ...
        <div className="md:col-span-3 flex flex-col justify-end h-full md:border-l md:border-[#222] md:pl-8 pb-4">
          <Reveal delay={0.4}>
            <div className="flex flex-col gap-6">
              <a 
                href="#projects" 
                className="group flex items-center justify-between p-6 bg-[#161616] border border-[#222] hover:border-accent transition-all duration-500"
              >
              ...
              <a 
                href="#contact" 
                className="group flex items-center justify-between p-6 border border-[#222] hover:bg-[#161616] transition-all duration-500"
              >
                <span className="text-[10px] uppercase tracking-widest font-bold">{t('hero.cta_secondary')}</span>
                <div className="w-2 h-2 rounded-full bg-[#333] group-hover:bg-accent transition-colors" />
              </a>
            </div>
          </Reveal>
        </div>
