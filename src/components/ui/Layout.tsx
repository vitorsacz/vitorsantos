...
export const Layout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="relative min-h-screen selection:bg-accent selection:text-ink">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-[#222] bg-[var(--nav-bg)] backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-12 h-20 flex items-center justify-between">
          <div className="flex flex-col">
            ...
            <span className="text-[11px] tracking-[0.1em] text-[#888] font-mono mt-1">ARCH_PORTFOLIO_V2.0</span>
          </div>
            ...
            <div className="hidden md:flex gap-10">
              {['Expertise', 'Experience', 'Projects', 'Contact'].map((item) => (
                <a 
                  ...
                  className="text-[10px] uppercase tracking-[0.2em] text-[#666] hover:text-white transition-colors cursor-pointer"
                >
      ...
      <footer className="border-t border-[#222] mt-24 py-16 bg-[#161616]">
        <div className="section-container flex flex-col md:flex-row justify-between items-end gap-12">
          <div className="flex flex-wrap gap-12 md:gap-20">
            <div className="flex flex-col gap-2">
              ...
              <span className="text-xs font-medium text-[#AAA]">Estrutura de arquivos validada</span>
            </div>
            <div className="flex flex-col gap-2">
              <span className="text-[9px] uppercase tracking-widest text-[#555]">Regras de Negócio</span>
              <span className="text-xs font-medium text-[#AAA]">Mapeadas com sucesso</span>
            </div>
            <div className="flex flex-col gap-2">
              <span className="text-[9px] uppercase tracking-widest text-[#555]">© 2024</span>
              <div className="flex gap-4">
                <a href="#" className="text-xs text-[#888] hover:text-white transition-colors">LinkedIn</a>
                <a href="#" className="text-xs text-[#888] hover:text-white transition-colors">GitHub</a>
              </div>
            </div>
          </div>
          <div className="text-[40px] font-black text-[#1A1A1A] tracking-tighter select-none leading-none">
            V.SANTOS / 26
          </div>
        </div>
      </footer>
